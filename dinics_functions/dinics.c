...
/*   Updated: 2019/12/17 17:08:16 by ygroenev      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "lemin.h"

static t_path_data	*get_start(t_data *ants)
{
	t_path_data	*start;
...
void			find_path(t_path_data **path, t_path_set **data_set, t_data **ants, t_amount **amount)
{
	t_path_data	*new;
